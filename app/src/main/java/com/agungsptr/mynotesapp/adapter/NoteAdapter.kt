package com.agungsptr.mynotesapp.adapter
...
import com.agungsptr.mynotesapp.CustomOnItemClickListener
import com.agungsptr.mynotesapp.NoteAddUpdateActivity
import com.agungsptr.mynotesapp.R
...
class NoteAdapter(private val activity: Activity) :
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(note: Note) {
            with(itemView) {
                tv_item_id.text = note.id.toString()
